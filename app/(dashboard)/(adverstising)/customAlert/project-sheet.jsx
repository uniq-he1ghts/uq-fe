      ...
      <Sheet open={open}>
        ...
        >
          <SheetHeader className="px-0">
            <SheetTitle>{project ? "Edit " : "Create a new"} Alert</SheetTitle>
          </SheetHeader>
          <ScrollArea className="h-[calc(100%-40px)]">
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="space-y-4  mt-6">
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <>
                        ...
                        <Input type="file" id="AlertLogo" className="hidden" />
                      </>
                    )}
                  />
                </div>
                ...
                <div>
                  <Label htmlFor="AlertName" className="mb-1.5">
                    Alert Name
                  </Label>
                  <Input
                    type="text"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="Select Metric" className="mb-1.5">
                      Select Metric
                    </Label>
                    <Controller
                      name="Select Metric"
                      ...
                      render={({ field }) => (
                        <UiSelect>
                          ...
                          <SelectContent>
                            <SelectItem value="inprogress">ACoS</SelectItem>
                            <SelectItem value="urgent">ROAS</SelectItem>
                ...
                <div className="mb-6">
                  ...
                  <input
                    ...
                    className="w-80 p-2 m-1 bg-slate-900 h-10 placeholder-gray-400 placeholder:opacity-60 border-blue-500  rounded-md "
                    color="default"
                  />
                </div>
